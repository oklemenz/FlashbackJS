...
const Actions = {
  ...
  run1: { size: 5, rate: 25, previous: ["startrun", "run4"], next: "runstop", input: ["left+fire", "right+fire"], x: 2 },
  run2: { size: 5, rate: 25, previous: ["run1"], next: "runstop", input: ["left+fire", "right+fire"], x: 2 },
  run3: { size: 5, rate: 25, previous: ["run2"], next: "runstop", input: ["left+fire", "right+fire"], x: 2 },
  run4: { size: 5, rate: 25, previous: ["run3"], next: "runstop", input: ["left+fire", "right+fire"], x: 2 },
  // jump: { size: 20, previous: ["stand"], next: "stand", input: ["left", "right"], x: 8 },
  // runjump: { size: 20, previous: ["run1", "run2", "run3", "run4"], next: "runstop", input: ["left", "right"], x: 12,
  // jumpup,
  // land,
  // crouch,
  // aim,
